...
import com.example.myapplication.auth.AddDataScreen
import com.example.myapplication.auth.GetDataScreen
import com.example.myapplication.auth.LoginScreen
import com.example.myapplication.auth.MainScreen
import com.example.myapplication.auth.SecondMain
...
sealed class DestinationScreen(val route: String) {
    ...
    object SecondMain: DestinationScreen("secondmain")
    object  Add:DestinationScreen("add")
    object GetData:DestinationScreen("getData")
}
...
fun AuthenticationApp() {
    ...
    NavHost(
        ...
        composable(DestinationScreen.SecondMain.route) {
            SecondMain(navController, vm =vm)
        }
        composable(DestinationScreen.Add.route) {
            AddDataScreen(navController, vm)
        }
        composable(DestinationScreen.GetData.route) {
            GetDataScreen(navController, vm)
        }
    }
}
